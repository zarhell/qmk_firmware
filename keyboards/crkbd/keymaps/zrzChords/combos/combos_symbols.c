...
const uint16_t PROGMEM gui_combo[]         = { KC_Q, KC_W, COMBO_END };

const uint16_t PROGMEM curly_brace_combo[] = { KC_ESC, KC_A, COMBO_END };
const uint16_t PROGMEM paren_combo[]      = { KC_ESC, KC_Z, COMBO_END };

const uint16_t PROGMEM bracket_close_combo[] = { KC_ESC, KC_W, COMBO_END };
const uint16_t PROGMEM curly_close_combo[]   = { KC_ESC, KC_S, COMBO_END };
const uint16_t PROGMEM paren_close_combo[]   = { KC_ESC, KC_X, COMBO_END };
...
const uint16_t PROGMEM left_acute[]  = { KC_D, KC_R,          COMBO_END };
const uint16_t PROGMEM left_comment[]= { KC_X, KC_D, KC_F,    COMBO_END };
const uint16_t PROGMEM left_tild[]  = { KC_Q, KC_F, COMBO_END };
const uint16_t PROGMEM left_quote[] = { KC_W, KC_R, COMBO_END };
...
const uint16_t PROGMEM left_dlr[] = { KC_X, KC_C, KC_F, COMBO_END };
...
const uint16_t PROGMEM left_eq[]   = { KC_E, KC_T,        COMBO_END };
const uint16_t PROGMEM left_min[]  = { KC_F, KC_G,        COMBO_END };
const uint16_t PROGMEM left_unds[] = { KC_V, KC_B,        COMBO_END };
const uint16_t PROGMEM left_plus[] = { KC_D, KC_F, KC_G, COMBO_END };
