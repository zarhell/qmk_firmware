...
#include "features/gui_state.h"
#include "/features/layer_frame.h"
...
static const char* layer_ref[6] = {LAYER_NAME_0, LAYER_NAME_1, LAYER_NAME_2, LAYER_NAME_3, LAYER_NAME_4};
